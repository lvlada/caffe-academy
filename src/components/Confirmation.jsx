    ...
    <>
      <div className="confirmation-page">
        ...
        <div className="confirmation-form">
          ...
          <p>
            Čestitamo! Uspešno ste se registrovali. <br />
            Sada možete uživati u brzom i jednostavnom <br />
            naručivanju omiljene kafe online!
          </p>

          <button className="backToHomePageButton" onClick={handleHomePage}>
